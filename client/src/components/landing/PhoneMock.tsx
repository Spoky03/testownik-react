export const PhoneMock = ({children, className}: {children?: React.ReactNode, className?:string}) => {
  return (
    <div className={`relative mx-auto outline-0 dark:outline dark:outline-1 dark:outline-white border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] transition-shadow duration-1000 ${className}`}>
